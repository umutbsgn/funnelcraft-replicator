  ...
  return (
    <div className="py-20 px-4">
      <div className="max-w-6xl mx-auto">
        <h2 className="text-2xl md:text-3xl font-semibold text-center mb-12 transition-all duration-500 ease-in-out hover:scale-105">
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-12 place-items-center mx-auto max-w-4xl">
          <div className="w-32 h-16 flex items-center justify-center transition-all duration-300 ease-in-out hover:scale-110">
            <img 
