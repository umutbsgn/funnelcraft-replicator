    ...
    <div className="py-32 md:py-48 px-4 md:px-8 opacity-0 animate-fadeInScale" style={{ animationDelay: "0.3s" }}>
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-12">
          <div className="bg-black/20 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-lg transition-all duration-500 ease-in-out hover:scale-105 hover:bg-black/30 opacity-0 animate-fadeIn" style={{ animationDelay: "0.7s" }}>
          ...
          <div className="bg-black/20 backdrop-blur-xl border border-white/10 p-6 md:p-8 rounded-lg transition-all duration-500 ease-in-out hover:scale-105 hover:bg-black/30 opacity-0 animate-fadeIn" style={{ animationDelay: "0.9s" }}>
            <p className="text-base md:text-lg mb-4 transition-opacity duration-300 hover:opacity-90">
