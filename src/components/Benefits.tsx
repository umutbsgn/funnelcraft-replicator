export const Benefits = () => {
  return (
    <section className="py-32 md:py-48 px-4 md:px-8 opacity-0 animate-fadeInScale" style={{ animationDelay: "0.3s" }} aria-labelledby="benefits-title">
      <div className="max-w-6xl mx-auto">
        <h2 id="benefits-title" className="text-4xl md:text-5xl lg:text-6xl font-bold mb-24 md:mb-32 text-center opacity-0 animate-revealUp px-4 md:px-0 text-white" style={{ animationDelay: "0.5s" }}>
          Skalieren Sie ihr Geschäft,<br />
          <span className="text-primary">nicht Ihren Workload.</span>
        </h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <article className="space-y-4 p-6 md:p-8 rounded-lg transition-all duration-500 ease-in-out hover:bg-black/30 backdrop-blur-xl bg-black/20 border border-white/10 opacity-0 animate-fadeIn hover:scale-105" style={{ animationDelay: "0.7s" }}>
          ...
          <article className="space-y-4 p-6 md:p-8 rounded-lg transition-all duration-500 ease-in-out hover:bg-black/30 backdrop-blur-xl bg-black/20 border border-white/10 opacity-0 animate-fadeIn hover:scale-105" style={{ animationDelay: "0.9s" }}>
            <div className="h-64 md:h-64 w-full mb-4 md:mb-6 overflow-hidden rounded-lg">
              <img 
          ...
          <article className="space-y-4 p-6 md:p-8 rounded-lg transition-all duration-500 ease-in-out hover:bg-black/30 backdrop-blur-xl bg-black/20 border border-white/10 opacity-0 animate-fadeIn hover:scale-105" style={{ animationDelay: "1.1s" }}>
            <div className="h-64 md:h-64 w-full mb-4 md:mb-6 overflow-hidden rounded-lg">
              <img 
