    ...
    <div className="py-32 md:py-48 px-4 md:px-8 opacity-100 animate-fadeInScale" style={{ animationDelay: "0.3s" }}>
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-32 space-y-16">
          <h2 className="text-4xl md:text-5xl lg:text-6xl font-bold mb-24 opacity-100 animate-revealUp" style={{ animationDelay: "0.5s" }}>
            Starten Sie mit uns <br />
            <span className="text-gray-400">in die Zukunft.</span>
          </h2>
          <div className="space-y-6 opacity-100 animate-fadeInScale" style={{ animationDelay: "0.7s" }}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="space-y-4 p-6 rounded-lg bg-black/20 backdrop-blur-xl border border-white/10 transition-all duration-500 hover:bg-black/30 opacity-100 animate-fadeInScale hover:scale-105" style={{ animationDelay: "0.9s" }}>
          ...
          <div className="space-y-4 p-6 rounded-lg bg-black/20 backdrop-blur-xl border border-white/10 transition-all duration-500 hover:bg-black/30 opacity-100 animate-fadeInScale hover:scale-105" style={{ animationDelay: "1.1s" }}>
            <div className="flex items-center space-x-2">
              <svg className="w-6 h-6 text-primary animate-glow" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="space-y-4 p-6 rounded-lg bg-black/20 backdrop-blur-xl border border-white/10 transition-all duration-500 hover:bg-black/30 opacity-100 animate-fadeInScale hover:scale-105" style={{ animationDelay: "1.3s" }}>
            <div className="flex items-center space-x-2">
              <svg className="w-6 h-6 text-primary animate-glow" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
