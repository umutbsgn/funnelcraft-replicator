    ...
    <div className="py-12 md:py-20 px-4 md:px-8">
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12">
          <div className="space-y-4 p-6 md:p-8 rounded-lg transition-all duration-300 ease-in-out hover:bg-black/30 backdrop-blur-xl bg-black/20 border border-white/10">
